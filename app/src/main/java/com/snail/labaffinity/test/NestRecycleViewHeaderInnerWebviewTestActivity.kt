...
import com.snail.labaffinity.databinding.ActivityNestRecycleviewHeaderInnerwebviewBinding
...
class NestRecycleViewHeaderInnerWebviewTestActivity : AppCompatActivity() {
    val list = mutableListOf<ItemVo>()
    var webview: WebView? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = ActivityNestRecycleviewHeaderInnerwebviewBinding.inflate(layoutInflater)
        ...
        val adapter =
            object :
                ...
                override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
                    ...
                    val button = Button(this@NestRecycleViewHeaderInnerWebviewTestActivity)
